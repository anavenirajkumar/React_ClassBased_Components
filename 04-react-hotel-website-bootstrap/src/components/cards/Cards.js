                        ...
                        <div className="col-md-3">
                            <div className="card">
                                ...
                                <div className="card-body">
                                    ...
                                    <p className="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Deserunt excepturi minus non numquam pariatur voluptate voluptatem! At impedit perspiciatis possimus.</p>
